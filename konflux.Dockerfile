...
RUN CGO_ENABLED=1 GOOS=linux go build -a -mod=mod -ldflags '-X github.com/vmware-tanzu/velero/pkg/buildinfo.Version=v1.14.1-OADP' -tags strictfipsruntime -o ./bin/velero ./cmd/velero
